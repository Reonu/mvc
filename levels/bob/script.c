...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_AMP, 813, -1875, -7678, 0, 0, 0, 0x00000000, bhvCirclingAmp),
		OBJECT(MODEL_AMP, 1524, -1387, -2770, 0, 0, 0, 0x00000000, bhvCirclingAmp),
		OBJECT(MODEL_AMP, 813, -1875, -8543, 0, 0, 0, 0x00000000, bhvCirclingAmp),
		OBJECT(MODEL_AMP, 813, -1875, -9305, 0, 0, 0, 0x00000000, bhvCirclingAmp),
		OBJECT(MODEL_GOOMBA, 6780, -1931, -5547, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_WOODEN_SIGNPOST, 5085, -2340, -5708, 0, 0, 0, 0x00000000, bhvMessagePanel),
		...
		OBJECT(MODEL_FAN_SPRING, -3139, -1624, -7060, 0, 0, 0, 0x01000000, bhvGreenSpring),
		OBJECT(MODEL_FLYGUY, -2624, -1047, -7060, 0, 0, 0, 0x01000000, bhvFlyGuy),
		OBJECT(0xFF, 784, -2395, -5656, 0, 0, 0, 0x01000000, bhv1Up),
		OBJECT(MODEL_MAJORA_PLATFORM, -4930, -1989, -6975, 0, 0, 0, 0x00020000, bhvMajoraPlatform),
		OBJECT(MODEL_MAJORA_PLATFORM, -5528, -1989, -6975, 0, 0, 0, 0x02030500, bhvMajoraPlatform),
