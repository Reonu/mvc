...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_NONE, 4278, -1788, -4447, 0, 0, 0, 0x02020000, bhvAirborneDeathWarp),
		...
		OBJECT(MODEL_GREEN_SPRING, 4555, -2340, -4989, 0, 0, 0, 0x00000000, bhvGreenSpring),
		OBJECT(MODEL_YELLOW_SPRING, 4570, -2340, -5359, 0, 0, 0, 0x00000000, bhvGreenSpring),
		OBJECT(MODEL_RED_SPRING, 2424, -2555, -5654, 0, 0, 0, 0x00000000, bhvGreenSpring),
		OBJECT(MODEL_GREEN_SPRING, 801, -2478, -3681, 0, 0, 0, 0x00000000, bhvGreenSpring),
		OBJECT(MODEL_GREEN_SPRING, 801, -2478, -3224, 0, 0, 0, 0x00000000, bhvGreenSpring),
		OBJECT(0xFF, 784, -2395, -5656, 0, 0, 0, 0x01000000, bhv1Up),
		OBJECT(MODEL_SSL_PALM_TREE, 3932, -2340, -4532, 0, 0, 0, 0x00000000, bhvTree),
