...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_GREEN_COIN, 4100, -2340, -4946, 0, 0, 0, 0x00000000, bhvRedCoin),
		...
		OBJECT(MODEL_LAVA_PLATFORM, -4989, -1989, -7140, 0, 0, 0, 0x00000000, bhvLllSinkingLavaPlatform),
		OBJECT(MODEL_LAVA_PLATFORM, -6610, -2043, -7140, 0, 0, 0, 0x01000000, bhvLllSinkingLavaPlatform),
		OBJECT(MODEL_LAVA_PLATFORM, -8412, -1989, -4730, 0, 90, 0, 0x00000000, bhvLllSinkingLavaPlatform),
		OBJECT(MODEL_YELLOW_SPRING, -8103, -1880, -10252, 0, 0, 0, 0x00000000, bhvGreenSpring),
		OBJECT(MODEL_YELLOW_SPRING, -8103, -1046, -10509, 0, 0, 0, 0x00000000, bhvGreenSpring),
		OBJECT(MODEL_YELLOW_SPRING, -8103, -381, -10024, 0, 0, 0, 0x00000000, bhvGreenSpring),
		...
		OBJECT(MODEL_RED_COIN, -4992, -1843, -7141, 0, 0, 0, 0x00000000, bhvRedCoin),
		...
		OBJECT(MODEL_RED_COIN, -9377, 291, -7528, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -5516, -1780, -9549, 0, 0, 0, 0x00000000, bhvRedCoin),
		OBJECT(MODEL_RED_COIN, -5130, -1681, -7994, 0, 0, 0, 0x00000000, bhvRedCoin),
		...
		OBJECT(MODEL_STAR, 5463, -806, -8268, 0, 0, 0, 0x07000000, bhvStar),
		OBJECT(MODEL_STAR, -3598, -1738, -7213, 0, 0, 0, 0x08000000, bhvStar),
