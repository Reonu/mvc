...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_MAJORA_PLATFORM, 3366, -1536, -6507, 0, 0, 0, 0x01030500, bhvMajoraPlatform),
		OBJECT(MODEL_MAJORA_PLATFORM, 3646, -1536, -6507, 0, 0, 0, 0x01030500, bhvMajoraPlatform),
		OBJECT(MODEL_MAJORA_PLATFORM, 3366, -1536, -6154, 0, 0, 0, 0x03030500, bhvMajoraPlatform),
		OBJECT(MODEL_MAJORA_PLATFORM, 3642, -1536, -6154, 0, 0, 0, 0x04030500, bhvMajoraPlatform),
