...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_MAJORA_PLATFORM, 4244, -2231, -6507, 0, 0, 0, 0x00020000, bhvMajoraPlatform),
		OBJECT(MODEL_MAJORA_PLATFORM, 3366, -2231, -6507, 0, 0, 0, 0x02031000, bhvMajoraPlatform),
		OBJECT(MODEL_MAJORA_PLATFORM, 3646, -2231, -6507, 0, 0, 0, 0x02030500, bhvMajoraPlatform),
