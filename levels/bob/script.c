...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_BULLET_BILL, -1901, -1453, -7060, 0, 0, 0, 0x01000000, bhvBulletBill),
		...
		OBJECT(MODEL_YELLOW_SPRING, -6659, -1880, -10252, 0, 0, 0, 0x00000000, bhvGreenSpring),
		OBJECT(MODEL_YELLOW_SPRING, -6659, -1046, -10509, 0, 0, 0, 0x00000000, bhvGreenSpring),
		OBJECT(MODEL_YELLOW_SPRING, -6659, -381, -10024, 0, 0, 0, 0x00000000, bhvGreenSpring),
		OBJECT(MODEL_MAJORA_PLATFORM, -6709, -399, -8931, 0, 0, 0, 0x03031500, bhvMajoraPlatform),
		OBJECT(MODEL_MAJORA_PLATFORM, -7290, -401, -8385, 0, 0, 0, 0x04031700, bhvMajoraPlatform),
		...
		OBJECT(MODEL_RED_COIN, -6541, -1879, -7141, 0, 0, 0, 0x00000000, bhvRedCoin),
		...
		OBJECT(MODEL_STAR, 5477, -5, -7013, 0, 0, 0, 0x07000000, bhvStar),
		OBJECT(MODEL_STAR, -3598, -1738, -7213, 0, 0, 0, 0x08000000, bhvStar),
		OBJECT(MODEL_STAR, -6656, 541, -10285, 0, 0, 0, 0x09000000, bhvStar),
